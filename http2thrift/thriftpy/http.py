...
from http2thrift.thriftpy._compat import PY3
if PY3:
...
from http2thrift.thriftpy.thrift import TProcessor, TClient
from http2thrift.thriftpy.server import TServer
from http2thrift.thriftpy.transport import (
    TTransportBase,
    TMemoryBuffer
)
...
from http2thrift.thriftpy.protocol.binary import TBinaryProtocolFactory
...
from http2thrift.thriftpy.transport.buffered import (
    TBufferedTransport,
